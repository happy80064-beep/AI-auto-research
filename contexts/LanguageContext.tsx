...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'setup.placeholder.demo': '例如：25-30 岁女性，本科学历...',
    'setup.placeholder.persona': '例如：性格开朗但有选择困难...',
    ...
    'review.subtitle': 'AI 已生成初步策略，您可以手动或借助 AI 修改',
    ...
    'voice.error.general': '语音识别错误',
    'voice.error.support': '当前浏览器不支持语音识别',
    'voice.error.start': '无法启动语音识别',
    'log.init': '初始化 Agent：商业分析师',
    'log.graph': '加载行业知识图谱',
    'log.persona': '解析目标用户画像',
    'log.demo': '分析基础属性',
    'log.extract': '提取画像特征',
    'log.goal': '设定调研目标',
    'log.model': '构建方法论模型',
  ...
  en: {
    ...
    'home.create.desc': 'Automated interview and questionnaire generation powered by AI Agents.',
    ...
    'setup.placeholder.objectives': 'E.g. uncover purchase decision path...',
    'opt.expert': 'Industry Expert',
    'opt.executive': 'Executive',
    'opt.client': 'Enterprise Client',
    'opt.potential': 'Potential User',
    'opt.other': 'Custom...',
    'review.title': 'Plan Preview and Optimization',
    'review.subtitle': 'AI generated a preliminary strategy. You can edit it manually or with AI.',
    'review.confirm': 'Confirm and Generate Link',
    ...
    'review.modal.start': 'Start Experience',
    ...
    'voice.error.support': 'Voice recognition is not supported',
    ...
    'log.fail': 'Generation failed, please retry.',
  },
};
